...
const nCasos = parseInt(4)
let nClientes = [1, 1, 1, 1]
let senhas = [100, 100, 90, 90, 20]

for (let n = 0; n < nCasos; n++) {
  nClientes[n] = parseInt(2)

  let senhasOrdenadas = Array.from(senhas.sort((a, b) => b - a))
  let contadorSemTroca = 0
  console.log(senhasOrdenadas)
